...
path <- list.files(file.path(BASE, "docs", "lab_notebooks", "percent_threshold", "rcp26"), "figs.rda", full.names = T) 
...
path <- list.files(file.path(BASE, "docs", "lab_notebooks", "percent_threshold", "rcp26_lawdomeCO2"), "figs.rda", full.names = T) 
...
path <- list.files(file.path(BASE, "docs", "lab_notebooks", "constrained_CO2"), "figs.rda", full.names = T) 
fig_list <- get(load(path))
